      ...
      <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <div class="flex justify-center">
            <a href="/listbuku" class="inline-flex text-white bg-[#9333EA] border-0 py-2 px-6 focus:outline-none rounded text-lg">Jelajahi</a>
          </div>
        </div>
        <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
          <img class="object-cover object-center rounded" alt="hero" src="/assets/images/digital-library.png">
        </div>
      </div>
    </section>
  </div>
      ...
      <div class="container px-5 py-24 mx-auto">
        ...
        <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
          <div class="p-4 md:w-1/3 flex flex-col text-center items-center">
            <div class="w-20 h-20 inline-flex items-center justify-center rounded-full bg-[#9333EA] mb-5 flex-shrink-0">
              <svg fill="#ffffff" width="32" height="32" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="search"><g data-name="Layer 2"><path d="m20.71 19.29-3.4-3.39A7.92 7.92 0 0 0 19 11a8 8 0 1 0-8 8 7.92 7.92 0 0 0 4.9-1.69l3.39 3.4a1 1 0 0 0 1.42 0 1 1 0 0 0 0-1.42zM5 11a6 6 0 1 1 6 6 6 6 0 0 1-6-6z" data-name="search"></path></g></svg>            
            </div>
            <div class="flex-grow">
          ...
          <div class="p-4 md:w-1/3 flex flex-col text-center items-center">
            <div class="w-20 h-20 inline-flex items-center justify-center rounded-full bg-[#9333EA] mb-5 flex-shrink-0">
              <svg fill="#ffffff" xmlns="http://www.w3.org/2000/svg" width="32" height="32" id="book"><path d="M5.042 32h18.91a2 2 0 0 0 2-2V9a1 1 0 0 0-1-1H8c-.05 0-.148.008-.242.014L5.042 8C3.364 8 2 6.718 2 5.042 2 3.364 3.322 2 5 2h23v23c0 .552.4 1 .954 1S30 25.552 30 25V1c0-.552-.494-1-1.046-1H5.042A5.036 5.036 0 0 0 .008 4.968L0 4.958v22A5.043 5.043 0 0 0 5.042 32z"></path></svg>
            </div>
            <div class="flex-grow">
      ...
      <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-col text-center w-full mb-12">
          ...
          <div class="login mt-7">
            <a href="/login" class=" text-white bg-[#9333EA] border-0 py-3 px-6 focus:outline-none rounded">Login</a>
          </div>
        </div>
      </div>
    </section>
